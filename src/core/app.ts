...
<title>ekip</title>
<link rel="icon" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'%3E%3Crect width='32' height='32' rx='8' fill='%23181a1f'/%3E%3Ctext x='16' y='21.5' font-family='system-ui,sans-serif' font-size='15' font-weight='700' text-anchor='middle' fill='%23fff'%3Eek%3C/text%3E%3C/svg%3E">
<style>${STYLES}</style>
</head>
<body>
<header class="bar">
